...
/**
 * calculate approximate median absolute deviation (mad)
 * the function has two parameters: $error$ and $bucketNum$
 * $error$ is the relative error, e.g., an approxMAD with $error$=0.01 satisfies 0.99 * MAD <= approxMAD <= 1.01 * MAD
 * @register: CREATE FUNCTION mad AS "cn.edu.thu.dquality.udf.UDAFMad"
