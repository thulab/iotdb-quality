package cn.edu.thu.iotdb.quality.frequency.util;
...
public class DWTUtil {
     ...
     * Input series has been transformed to the highest possible layer, which means there is 1 number in the last layer.
     * To alter this, you may refer to waveletTransform()
     *
     */
    public void inverse() {
        int n = data.length;
