...
\input{output_zh/PatternSymmetric.tex}
...
\input{output_zh/IQR.tex}
\input{output_zh/KSigma.tex}
\input{output_zh/LOF.tex}
\input{output_zh/Range.tex}
\input{output_zh/TwoSidedFilter.tex}


\chapter{频域相关}
\input{output_zh/Conv.tex}
\input{output_zh/Deconv.tex}
\input{output_zh/DWT.tex}
\input{output_zh/FFT.tex}
\input{output_zh/HighPass.tex}
\input{output_zh/IFFT.tex}
\input{output_zh/LowPass.tex}


\chapter{字符串处理}
\input{output_zh/RegexMatch.tex}
\input{output_zh/RegexReplace.tex}
\input{output_zh/Replace.tex}
\input{output_zh/Split.tex}
