...
\input{output_en/MinMax.tex}
\input{output_en/Mode.tex}
\input{output_en/MvAvg.tex}
\input{output_en/PACF.tex}
...
\input{output_en/Spline.tex}
\input{output_en/Spread.tex}
\input{output_en/Stddev.tex}
\input{output_en/IntegralAvg.tex}
\input{output_en/ZScore.tex}
...
\input{output_en/XCorr.tex}
\input{output_en/DTW.tex}
\input{output_en/PtnSym.tex}
\input{output_en/Pearson.tex}


\chapter{Anomaly Detection}
\input{output_en/IQR.tex}
\input{output_en/KSigma.tex}
\input{output_en/LOF.tex}
\input{output_en/MissDetect.tex}
...
\input{output_en/DWT.tex}
\input{output_en/FFT.tex}
\input{output_en/HighPass.tex}
\input{output_en/IFFT.tex}
\input{output_en/LowPass.tex}

\chapter{String Processing}
\input{output_en/RegexMatch.tex}
\input{output_en/RegexReplace.tex}
\input{output_en/RegexSplit.tex}
\input{output_en/StrReplace.tex}
